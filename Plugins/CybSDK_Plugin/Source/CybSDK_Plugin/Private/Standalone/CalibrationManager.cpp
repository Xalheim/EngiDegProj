...
{
	if (FCybSDK_PluginModule::GetVirtualizerInputDevice() != nullptr)
	{
...
void UCalibrationManager::CalculateTransform(float boundaryPoints[2][2])
{
	...
	TScriptInterface<IStandaloneVirtDeviceInterface> standaloneVirtDeviceInterface = FCybSDK_PluginModule::GetVirtualizerInputDevice()->GetDevice()->GetStandaloneVirtDeviceInterface();
