...
class CYBSDK_PLUGIN_API UVirtHapticEmitterComponent : public USceneComponent
{
	GENERATED_BODY()
...
class CYBSDK_PLUGIN_API FVirtHapticEmitterVisualizer : public FComponentVisualizer
{
public:
